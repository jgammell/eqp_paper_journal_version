...
In the tested datasets, we find 
...
\caption{Comparison of MLFF/SW topology with various datasets and network architectures. In all tests networks were trained for 100 epochs. The emphasis of this table is the improvement to the log-spread (equation \ref{eqn:spread}) when using the SW topology over the MLFF topology.}
\label{tbl:results}
\end{table}

\subsection{Matrix of correction magnitudes}
\label{sec:dw_matrix}
